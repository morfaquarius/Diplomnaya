 ...
 */
            !function(e, t) {
                ...
                }, t = "lgUpdateSlides", r = "lgBeforeSlide", o = {
                    pager: !0
                };
                return function() {
                    function i(t, r) {
                        return this.core = t, this.$LG = r, this.settings = e(e({}, o), this.core.settings), 
                        this;
                    }
                    return i.prototype.getPagerHtml = function(e) {
                        for (var t = "", r = 0; r < e.length; r++) t += '<span  data-lg-item-id="' + r + '" class="lg-pager-cont"> \n                    <span data-lg-item-id="' + r + '" class="lg-pager"></span>\n                    <div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' + e[r].thumb + '" /></div>\n                    </span>';
                        return t;
                        ...
                        if (this.settings.pager) {
                            ...
                            i.html(this.getPagerHtml(this.core.galleryItems)), i.first().on("click.lg touchend.lg", (function(t) {
                                var r = e.$LG(t.target);
                        ...
                        this.core.outer.find(".lg-pager-outer").remove(), this.core.LGel.off(".lg.pager"), 
        ...
        let gotoblock_gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0) => {
            ...
            if (targetBlockElement) {
                ...
                function scrollToPosition(currentTime) {
                    ...
                    if (elapsedTime < duration) requestAnimationFrame(scrollToPosition); else {
...
***************************************************************************** */
        ...
        var lg_autoplay_min = __webpack_require__(491);
        var lg_fullscreen_min = __webpack_require__(179);
        var lg_pager_min = __webpack_require__(251);
            ...
            galleries.forEach((gallery => {
                galleyItems.push({
                    ...
                    galleryClass: lightgallery_es5(gallery, {
                        plugins: [ lg_autoplay_min, lg_fullscreen_min, lg_pager_min, lg_zoom_min ],
